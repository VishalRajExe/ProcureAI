            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-[#12151C] border border-[#1E2330] rounded-2xl p-6 space-y-4">
                ...
                <textarea
                  ...
                  className="w-full bg-[#0B0D12] border border-[#1E2330] rounded-xl p-4 text-xs font-mono text-white focus:outline-none focus:border-[#3E52FF] transition-colors leading-relaxed"
                />
